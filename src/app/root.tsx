  ...
  return (
    <html lang="fa" dir="rtl">
      <head>
        ...
        <title>سامانه گزارش‌گیری مطالعه</title>
        <meta
          name="description"
          content="سیستم پیگیری پیشرفت تحصیلی دانش‌آموزان با نظارت مستقیم مشاور"
        />
      ...
      <body className="bg-gray-50 min-h-screen font-vazirmatn">
